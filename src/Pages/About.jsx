            ...
            {teamMembers.map((doc, index) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <button className="w-full py-2 text-sm font-medium text-white bg-purple-500 border border-purple-500 rounded-lg hover:text-purple-500 transition-all duration-300">
