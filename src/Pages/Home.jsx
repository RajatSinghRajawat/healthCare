...
const Home = () => {
  const features = [
    ...
    },
    {
      ...
      desc: "Full range of healthcare services under one roof.",
    },
    {
      icon: <FaHeartbeat />,
      title: "Patient-Centered",
      desc: "Focused on your comfort and well-being.",
    },
    {
      icon: <FaAmbulance />,
      title: "24/7 Emergency",
      desc: "Quick response and emergency care anytime.",
    },
    {
      icon: <FaPills />,
      title: "Pharmacy Support",
      desc: "In-house pharmacy for your convenience.",
    },
    {
      icon: <FaMicroscope />,
      title: "Advanced Diagnostics",
      desc: "Accurate and fast lab & imaging services.",
    },
    {
      icon: <FaRegSmile />,
      title: "Friendly Staff",
      desc: "Caring and approachable healthcare team.",
    },
  ];
  ...
  const doctors = [
    {
      name: "Dr. Vivek Gupta",
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRUNBIL0_hJu7hxnyfJpFl8yzjxp6Q7zHUJMw&s",
      degree: "MD, MBBS",
      text: "Preventive healthcare expert.",
    },
    {
      name: "Dr. Anjali Sharma",
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDz4ooWq1gmfTSE4-4jHzHaSPM_8_f4h_qQQ&s",
      degree: "MD, Nutrition",
      text: "Specialist in nutrition and lifestyle.",
    },
    {
      name: "Dr. Rajesh Kumar",
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn=9GcRbS9oQS-5J8RcHMkBW5EktnFh9FX_pkAtrFQ&s",
      degree: "PhD, Psychology",
      text: "Mental health and stress management.",
    },
    {
      name: "Dr. Priya Singh",
      img: "https://www.indiraivf.com/sites/default/files/styles/wide/public/2025-05/Dr-Priya-Singh-%28Bareilly%29.jpg.webp?VersionId=bxPkVVZdNZ60mQHWWboy0F3JB4ZMbR2B",
      degree: "MBBS, PT",
      text: "Physical fitness and holistic care.",
    },
    {
      name: "Dr. Neha Verma",
      img: "https://rajeye.com/wp-content/uploads/2024/01/19__2_-removebg-preview.png",
      degree: "MD Pediatrics",
      text: "Pediatric healthcare expert.",
    },
    {
      name: "Dr. Mohan Das",
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn=9GcTmpQTr0veD8booyvh23izIqevPNxQni0UBVw&s",
  ...
  const specialties = [
    {
      icon: <FaHeartbeat />,
      title: "Cardiology",
      desc: "Advanced care for heart and vascular health.",
    },
    {
      icon: <FaBrain />,
      title: "Neurology",
      desc: "Diagnosis and treatment for brain & nervous system disorders.",
    },
    {
      icon: <FaXRay />,
      title: "Radiology",
      desc: "Modern imaging for accurate medical evaluations.",
    },
    {
      icon: <FaBaby />,
      title: "Pediatrics",
      desc: "Compassionate care for children and adolescents.",
    },
    {
      icon: <FaLungs />,
      title: "Pulmonology",
      desc: "Specialized treatment for lung and respiratory conditions.",
    },
    {
      icon: <FaTeeth />,
      title: "Dentistry",
      desc: "Complete dental care for a healthy smile.",
    },
    {
      icon: <FaEye />,
      title: "Ophthalmology",
      desc: "Eye health services and vision care.",
    },
    {
      icon: <FaBone />,
      title: "Orthopedics",
      desc: "Bone, joint, and muscle treatment for all ages.",
    },
  ];
  ...
  const reviews = [
    {
      ...
      review:
        "The doctors were incredibly kind and attentive. I felt truly cared for and confident in my treatment.",
    },
    {
      name: "James Walker",
      img: "https://randomuser.me/api/portraits/men/46.jpg",
      review:
        "State-of-the-art facilities and an amazing staff. I was impressed by how smoothly everything went.",
    },
    {
      name: "Sophia Johnson",
      img: "https://randomuser.me/api/portraits/women/50.jpg",
      review:
        "From booking my appointment to post-treatment care, the entire process was seamless and professional.",
    },
    {
      name: "Daniel Lee",
      img: "https://randomuser.me/api/portraits/men/52.jpg",
      review:
        "They truly put patients first. I recommend them to everyone who values quality healthcare.",
    },
  ];
  ...
  const cards = [
    {
      ...
      description:
        "Collaborate with our healthcare network to provide top-notch services and expand your reach.",
    ...
    },
    {
      ...
      description:
        "Join our network today and be a part of our mission to deliver quality healthcare.",
    ...
    <div>
          ...
          <div className="flex flex-col lg:flex-row items-center">
            ...
            <div className="lg:w-1/2 mb-6 lg:mb-0">
              ...
              <p className="text-lg sm:text-xl mb-6">
                We provide expert medical consultations, diagnostics, and
                treatments with compassion and care.
              </p>
              <button className="inline-flex items-center px-6 py-3 text-lg font-medium text-white bg-purple-500 border-2 border-purple-500 rounded-lg shadow-sm hover:bg-transparent hover:scale-105 hover:text-purple-500 transition-all duration-300">
      ...
      <div className="py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-lg mb-8">
            Delivering excellence in healthcare with compassion, technology, and
            trust.
          </p>
      ...
      <div className="py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-lg mb-8">
            Dedicated professionals bringing expertise, compassion, and care to
            every patient.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              return (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <button className="w-full py-2 text-sm font-medium text-white bg-purple-500 border border-purple-500 rounded-lg hover:bg-transparent hover:text-purple-500 transition-all duration-300">
      ...
      <div className="py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-lg mb-8">
            From prevention to advanced treatments, our specialties ensure
      ...
      <div className="py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-lg mb-8">
            Real stories from real patients — sharing their experiences of care
            and healing.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {reviews.map((item, index) => (
              ...
              >
                ...
                <p className="text-sm italic min-h-[80px] mb-4">
                  "{item.review}"
                </p>
                <img
                  src={item.img}
      ...
      <div className="py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-lg mb-8 max-w-xl mx-auto">
            Stay informed with expert advice, wellness tips, and the latest
            healthcare updates.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {articles.map((item, index) => (
              ...
              >
                ...
                <div className="p-6 flex flex-col justify-between flex-grow">
                  <div>
                    <h5 className="font-bold text-lg mb-2 min-h-[50px]">
                      {item.title}
                    </h5>
                    <p className="text-sm min-h-[60px]">{item.desc}</p>
                  </div>
                  <button className="mt-4 inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-purple-500 border-2 border-purple-500 rounded-lg hover:bg-transparent hover:scale-105 hover:text-purple-500 transition-all duration-300">
                    Read More
      ...
      <div className="py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg mb-10 max-w-xl mx-auto">
            We're here for you 24/7. Call us anytime — because your health and
            safety can't wait.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-lg shadow-sm border-2 border-purple-500">
              ...
              <button className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-purple-500 border-2 border-purple-500 rounded-lg hover:bg-transparent hover:scale-105 hover:text-purple-500 transition-all duration-300">
                Request Ambulance
              </button>
            </div>
            <div className="p-6 rounded-lg shadow-sm border-2 border-purple-500">
      ...
      <div className="py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg mb-10">
            Connect with us to expand your healthcare reach and make a real
            difference.
          </p>
