...
//   return (
//     <header className="sticky top-0 z-50 backdrop-blur-md shadow-lg bg-white text-gray-900">
...
//               </button>
//               {isDropdownOpen && (
//                 <div className="md:absolute md:top-full md:left-0 flex flex-col bg-white shadow-lg rounded-lg mt-1 md:min-w-[200px] overflow-hidden">
...
const Navbar = () => {
  ...
  // Auto-generate paths from names
  const navLinks = ["Home", "About", "Doctors", "Stories", "Blog", "Contact & Support"].map(
    (name) => ({
      name,
      path:
        name === "Home"
